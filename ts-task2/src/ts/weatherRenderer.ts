class WeatherRenderer{
    ...
    createWeatherBody = function(clientClickX: number, clientClickY: number, monthName: string, choosedDay: string): void {
        ...
        container.style.backgroundImage = "url('src/assets/flower.jpg')";
    ...
    insertWeatherData = function(obj: IWeatherData): void {
