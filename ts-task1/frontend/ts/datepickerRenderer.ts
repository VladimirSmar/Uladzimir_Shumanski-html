class DatepickerRenderer{
    ...
    drawMonth = function (calendar: Calendar): void {
    ...
    drawPreviousMonthDays = function(previousMonthDaysCount: number, parentElement: HTMLDivElement, previousMonthTotalDaysCount: number): void {
    ...
    drawNextMonthDays = function(nextMonthDaysCount: number, parentElement: HTMLDivElement, nextMonthDayDate: number): void {
