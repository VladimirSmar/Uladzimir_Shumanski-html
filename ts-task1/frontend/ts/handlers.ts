...
Handlers.prototype.setHandlers = function(calendar, view, calendarRenderer): void {
    ...
    function createWeatherLayout(event): void {

        let weather: any = new WeatherService();
        let weatherView: any = new WeatherRenderer();

        let choosedElement: HTMLDivElement = event.target;
        let previousWeatherLayout: Element = document.body.getElementsByClassName("-sv-weather-ui")[0];
    ...
    function chooseMonthDayHandler(event): void {
